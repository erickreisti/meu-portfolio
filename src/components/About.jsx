...
import { FaMobileScreenButton, FaDisplay, FaPalette } from "react-icons/fa6";

export default function About() {
  return (
    <section name="about" className="my-24">
        <div className="max-w-[1280px] mx-auto w-full p-4 flex flex-col lg:flex-row items-center gap-12 lg:gap-8 relative">
          <div className="flex flex-col md:items-center md:justify-start text-center md:gap-0">
            <div className="flex justify-center">
              <span className="text-5xl font-semibold pb-8 relative">
                <TbTargetArrow className="mx-auto text-7xl text-yellow-500" />
                Foco!
              </span>
            </div>
            <div className="flex flex-col justify-center sm:flex-row md:my-auto gap-10">
              <div className="sm:w-[140px]">
                <FaDisplay className="mx-auto text-6xl pb-4 md:pb-2 text-[#3f65ff]" />
                <span className="text-lg font-semibold">Web Developer</span>
              </div>
              <div className="sm:w-[140px]">
                <FaMobileScreenButton className="mx-auto text-6xl pb-4 md:pb-2 text-[#3f65ff]" />
                <span className="text-lg font-semibold">Layout Mobile</span>
              </div>
              <div className="sm:w-[140px]">
                <FaPalette className="mx-auto text-6xl pb-4 md:pb-2 text-[#3f65ff]" />
                <span className="text-lg font-semibold">Mockups</span>
              </div>
            </div>
            <div>
              <div>
                <svg
                  viewBox="0 0 162.50809 261.08079"
                  version="1.1"
                  id="svg76"
                  width="8rem"
                  height="8rem"
                  className="fill-yellow-500 absolute hidden lg:flex sm:top-[-140px] sm:right-4 -z-10"
                >
                  <sodipodi:namedview
                    id="namedview78"
                    pagecolor="#ffffff"
                    ...
                    <g id="Layer_2" data-name="Layer 2">
                      <g id="OBJECTS">
                        ...
                        <circle
                          ...
                          cy="206.34"
                          r="54.75"
                          transform="rotate(-45,107.72786,206.33766)"
                          id="circle70"
                        />
                      </g>
                    </g>
          ...
          <div className="relative flex flex-col">
            ...
            <p className="font-light text-justify">
              Bem vindos ao meu portifólio, estou empolgado em mostrar-los a
              vocês. Meu nome é Érick Reis, sou tecnólogo em Tecnologia da
              Informação, e graduado em Sistemas de Informação. Trabalhei muitos
              anos em algumas áreas dentro da T.I, e desde então, venho
              enviesado no desenvolvimento web. Gosto muito do processo de
              desenvolvimento desde a parte de planejamento até qual cor irei
              usar! A principal função da carreira de T.I é a resolução de
              problemas, e a partir desta premissa, estou aqui para resolver o
              seu problemar da melhor forma possível de maneira direta e
              responsável.
            </p>
          </div>
        </div>
